...
// ==========================================
const char* ssid = "Nathasha";
const char* password = "20021030";
const char* server_url = "http://192.168.217.213:5001/detect"; // Backend URL
...
static esp_err_t stream_handler(httpd_req_t *req){
    ...
    // Set low quality for streaming
    sensor_t * s = esp_camera_sensor_get();
    s->set_framesize(s, FRAMESIZE_CIF); // 400x296 - Fast
    s->set_quality(s, 12);             // Lower quality for speed
    ...
    // Restore high quality settings after streaming
...
// ==========================================
#define MOTION_THRESHOLD 600    // Sensitivity (lower = more sensitive)
